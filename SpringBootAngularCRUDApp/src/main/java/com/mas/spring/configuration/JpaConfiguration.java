package com.mas.spring.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.mas.spring.repositories", 
...
public class JpaConfiguration {
	...
	@Value("${datasource.samplepp.maxPoolSize:10}")
	...
	/*
	 * Set HikariCP pooled DataSource.
	 */
	@Bean
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.mas.spring.model" });
	...
	/*
	 * We can specify any provider with specific properties.
	 */
